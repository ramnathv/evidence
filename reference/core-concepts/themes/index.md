...
|------|-------------|---------|---------|
| `default` | The default appearance mode. | dark, light, system | light |
| `switcher` | Shows/hides the appearance switcher in the kebab menu in the top right which allows users to switch the appearance of your application between light and dark mode. | true, false | false |
